    ...
    public partial class ThongKe : UserControl
    {
        ...
        private void CapNhatSanPhamBanChay()
        {
            ...
            if (sanphams.Count > 0)
            {
                if (sanphams.Count == 1)
                {
                    tbl_TenSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[0].Idsp +"'")[0].TenSanPham1;
                    tbl_LoaiSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[0].Idsp + "'")[0].LoaiSanPham1;
                }
                ...
                if (sanphams.Count == 2)
                {
                    tbl_TenSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[0].Idsp + "'")[0].TenSanPham1;
                    tbl_LoaiSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[0].Idsp + "'")[0].LoaiSanPham1;
                    tbl_TenSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[1].Idsp + "'")[0].TenSanPham1;
                    tbl_LoaiSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[1].Idsp + "'")[0].LoaiSanPham1;
                }
                ...
                if (sanphams.Count == 3)
                {
                    ...
                    tbl_TenSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[1].Idsp + "'")[0].TenSanPham1;
                    tbl_LoaiSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[1].Idsp + "'")[0].LoaiSanPham1;
                    tbl_TenSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[2].Idsp + "'")[0].TenSanPham1;
                    tbl_LoaiSanPhamTop1.Text = modify.SanPhams("select * from SanPham where ID = '" + sanphams[2].Idsp + "'")[0].LoaiSanPham1;
                }
            }
        }
